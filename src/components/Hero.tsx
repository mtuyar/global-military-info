  ...
  return (
    <section className="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-sm uppercase tracking-[0.3em] text-white/50 mb-6 font-medium">
            {t.heroSub}
          </h2>
        </motion.div>
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-white/60 max-w-2xl font-light leading-relaxed mb-12"
        >
          {t.heroDesc}
        </motion.p>
